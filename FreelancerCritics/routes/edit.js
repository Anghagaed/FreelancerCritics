...
var edit_authentication = function(req, res) {
	...
	var username = session.FindSession(req);//for current user
	var password = "";
...
// 		con.PrepQuery('UPDATE User SET ciphertext=? WHERE username=?',[newciphertext.toString(),username] ,function (err, result) {
// 	    	if (err) throw err;
//             //console.log("messages:" + newciphertext.toString());
// 	    	console.log("Updated User table. Redirecting to profilepage!");
